...
(GetKeyState((int)DodgeBlock.PressedKey) & KeyPressed) != 0)
        ...
        private static int GetKeyState(int key)
        {
            ...
            {
                case KeyCode.Up:
                    if (Program.form.ConsoleRrichTextBox.Parent.UpButtonDown())
                        return KeyPressed;
                    else
                        return 0;
                case KeyCode.Down:
                    if (Program.form.ConsoleRrichTextBox.Parent.DownButtonDown())
                        return KeyPressed;
                    else
                        return 0;
                case KeyCode.Right:
                    if (Program.form.ConsoleRrichTextBox.Parent.RightButtonDown())
                        return KeyPressed;
                    else
                        return 0;
                case KeyCode.Left:
                    if (Program.form.ConsoleRrichTextBox.Parent.LeftButtonDown())
                        return KeyPressed;
                    else
                        return 0;
            }
